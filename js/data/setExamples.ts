...
setA.<span class="method">difference</span>(setB);`,
      description: `The <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set/difference" target="_blank" rel="noopener noreferrer">difference()</a> method returns a new set containing only the elements that are in the first set but not in the second one.`,
      example:
...
setA.<span class="method">intersection</span>(setB);`,
      description: `The <a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Set/intersection" target="_blank" rel="noopener noreferrer">intersection()</a> method returns a new set containing only the elements that are present in both the original set and a second set.`,
...
setA.<span class="method">isSubsetOf</span>(setB);`,
      description: `The <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set/isSubsetOf" target="_blank" rel="noopener noreferrer">isSubsetOf()</a> method returns true if every element in the original set also exists in the provided set; otherwise, it returns false.`,
      example:
...
setA.<span class="method">symmetricDifference</span>(setB);`,
      description: `The <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set/symmetricDifference" target="_blank" rel="noopener noreferrer">symmetricDifference()</a> method returns a new set containing only the elements that are in either set, but not in both.`,
...
setA.<span class="method">union</span>(setB);`,
      description: `The <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set/union" target="_blank" rel="noopener noreferrer">union()</a> method returns a new set containing all elements from both sets.`,
