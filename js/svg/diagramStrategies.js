...
function createDifferenceDiagram() {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" role="img" aria-label="difference diagram">
...
function createIntersectionDiagram() {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" role="img" aria-label="intersection diagram">
      <rect width="100%" height="100%" fill="#fff"/>
...
function createSymmetricDifferenceDiagram() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" role="img" aria-label="symmetric difference diagram">
    <rect width="100%" height="100%" fill="#fff"/>
...
function createUnionDiagram() {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" xml:space="preserve">
      <rect width="100%" height="100%" fill="#fff"/>
...
function createDisjointDiagram() {
  return `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" role="img" aria-label="disjoint sets diagram">
      <rect width="100%" height="100%" fill="#fff"/>
...
function createSubsetDiagram() {
  return `
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" role="img" aria-label="subset diagram">
    <rect width="100%" height="100%" fill="#fff"/>
...
function createSupersetDiagram() {
  return `
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CONFIG.SVG.WIDTH} ${CONFIG.SVG.HEIGHT}" role="img" aria-label="superset diagram">
    <rect width="100%" height="100%" fill="#fff"/>
    <circle cx="150" cy="100" r="75" fill="#fff" stroke="#111" stroke-opacity="0.4" stroke-width="2"/>
    <circle cx="150" cy="120" r="50" fill="#fff" stroke="#111" stroke-opacity="0.4" stroke-width="2"/>
